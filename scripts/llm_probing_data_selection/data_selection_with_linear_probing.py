...
with open(f'../../results/data_selection_linear_probing_eval/data_selection_with_linear_probing_results_{dataset_name}_{seed}.json', 'w') as f:
    json.dump(result, f)


df_result = pd.DataFrame(df_result)
df_result.to_csv('data_selection_with_linear_probing+.csv', index=False)